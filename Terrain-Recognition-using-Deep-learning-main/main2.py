...
def resnet_block(input_tensor, filters, kernel_size, strides=(1, 1), activation='relu', dropout_rate=0.2):
...
# Define the enhanced RESNET model
def enhanced_resnet_model(input_shape, num_classes):
    ...
    # Add more convolutional blocks with increased filters and dropout
...
# Create the enhanced RESNET model
model = enhanced_resnet_model(input_shape, num_classes)
...
# Save the model
model.save('enhanced_resnet_model.h5')
